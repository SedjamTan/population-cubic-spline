...
def f1(x):
    return ((12.327801029757717)*((x-1903)**3))+((-9.393051541049447*10**2)*((x-1903)**2))+((2.627648874654535*10**4)*(x-1903))+15559
def f2(x):
    return ((12.327801029757691)*((x-1918)**3))+((-3.845541077658476*10**2)*((x-1918)**2))+((6.418599818483467*10**3)*(x-1918))+239969
def f3(x):
    return (-21.467707020583610)*((x-1939)**3)+(3.920973571088866*10**2)*((x-1939)**2)+(6.577008054687293*10**3)*(x-1939)+319339
def f4(x):
    return (26.441628097571940)*((x-1948)**3)+(-1.875307324468716*10**2)*((x-1948)**2)+(8.418107676645433*10**3)*(x-1948)+394642
def f5(x):
    return (-6.209322267287571)*((x-1960)**3)+(7.643678790657165*10**2)*((x-1960)**2)+(1.534015343607159*10**4)*(x-1960)+514346
def f6(x):
    return (26.222742930092501)*((x-1970)**3)+(5.780952235576806*10**2)*((x-1970)**2)+(2.876475530895928*10**4)*(x-1970)+737975
def f7(x):
    return (-82.660205931814261)*((x-1975)**3)+(9.714749755860248*10**2)*((x-1975)**2)+(3.651253027036523*10**4)*(x-1975)+899529
def f8(x):
    return (35.738165525725492)*((x-1980)**3)+(-2.684281133911951*10**2)*((x-1980)**2)+(4.002776458133940*10**4)*(x-1980)+1096046
def f9(x):
    return (2.578065506745601*10**2)*((x-1990)**3)+(8.037168523805697*10**2)*((x-1990)**2)+(4.538065197123315*10**4)*(x-1990)+1505219
def f10(x):
    return (-2.471194943250273*10**2)*((x-1995)**3)+(4.670815112498964*10**3)*((x-1995)**2)+(7.275331179563086e+04)*(x-1995)+1784441
def f11(x):
    return (-4.828035513331142*10**2)*((x-2000)**3)+(9.640226976235526*10**2)*((x-2000)**2)+(1.009275008462434*10**5)*(x-2000)+2234088
def f12(x):
    return (2.016132489715940*10**3)*((x-2007)**3)+(-9.174851880371838*10**3)*((x-2007)**2)+(4.345169656700538*10**4)*(x-2007)+2822216
def f13(x):
    return (-5.664906056985167*10**2)*((x-2010)**3)+(8.970340527071634*10**3)*((x-2010)**2)+(4.283816250710475*10**4)*(x-2010)+2924433
def f14(x):
    return (-3.622351823360717*10**2)*((x-2015)**3)+(4.729814415938920*10**2)*((x-2015)**2)+(9.005477235043234*10**4)*(x-2015)+3292071
def f15(x):
    return (-3.622351823360714*10**2)*((x-2020)**3)+(-4.960546293447180*10**3)*((x-2020)**2)+(6.761694809116586*10**4)*(x-2020)+3708890
# endregion
